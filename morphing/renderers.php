...
/**
 * extend the default core_renderer to allow creation of theme custom menu - which is different from the moodle std. custom menu
 * put here any other rendering specific functionality
 */
